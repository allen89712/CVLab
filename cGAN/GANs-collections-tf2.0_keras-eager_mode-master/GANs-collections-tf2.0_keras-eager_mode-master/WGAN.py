...
class WGAN():
    def __init__(self,args):
        ...
        self.datasets = load_mnist_data(datasets=self.datasets_name,batch_size=args.batch_size,model_name='WGAN')
    ...
    def train(self, load=False):
        ...
        for epoch in range(start_epoch,self.epoches):
            for batch_images, _ in self.datasets:
                ...
                if step % 50 == 0:
                    print ('step：{}, d_loss: {:.4f}, g_loss: {:.4F}'.format(step,self.critic_loss_metric.result(), self.g_loss_metric.result()))
