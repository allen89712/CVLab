...
class WGAN_GP():
    def __init__(self,args):
        ...
        self.datasets = load_mnist_data(datasets=self.datasets_name, model_name='WGAN_GP')
        ...
        for epoch in range(start_epoch,self.epoches):
            for batch_images, _ in self.datasets:
                ...
                if step % 50 == 0:
                    ...
                    print ('step：{}, d_loss: {:.4f}, g_oss: {:.4F}'.format(step,self.critic_loss_metric.result(), self.g_loss_metric.result()))
